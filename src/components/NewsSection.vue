  ...
  <div class="space-y-4" v-api-marker:news>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div 
        ...
        :key="article.id"
        class="bg-white/90 dark:bg-brand-navy-900/90 border border-slate-100/50 dark:border-brand-navy-700/20 rounded-[4px] overflow-hidden shadow-sm hover:shadow-md transition-[box-shadow] duration-300 flex flex-col group no-blur"
      >
