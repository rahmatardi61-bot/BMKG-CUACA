...
export const locationsList: LocationData[] = [
  ...
  { id: 'tangerang', name: 'Kota Tangerang', type: 'Kota', region: 'Banten', lat: -6.1783, lng: 106.6319, temp: 32, weather: 'Berawan', uv: 4, condition: 'berawan', tips: 'Tol Jakarta-Tangerang ramai lancar.' },
  { id: 'serang', name: 'Kota Serang', type: 'Kota', region: 'Banten', lat: -6.1173, lng: 106.1501, temp: 31, weather: 'Cerah Berawan', uv: 5, condition: 'cerah', tips: 'Jalur tol Tangerang-Merak kondusif.' },
  { id: 'karawang', name: 'Karawang', type: 'Kabupaten', region: 'Jawa Barat', lat: -6.3127, lng: 107.3372, temp: 32, weather: 'Cerah', uv: 5, condition: 'cerah', tips: 'Kawasan industri. Tol Cipali lancar.' },
  { id: 'subang', name: 'Subang', type: 'Kabupaten', region: 'Jawa Barat', lat: -6.5705, lng: 107.7590, temp: 30, weather: 'Cerah Berawan', uv: 5, condition: 'cerah', tips: 'Jalur Pantura aman dilalui.' },
  { id: 'indramayu', name: 'Indramayu', type: 'Kabupaten', region: 'Jawa Barat', lat: -6.3274, lng: 108.3215, temp: 32, weather: 'Cerah', uv: 5, condition: 'cerah', tips: 'Pantura kering, waspadai angin laut.' },
  { id: 'palimanan', name: 'Palimanan', type: 'Kecamatan', region: 'Cirebon, Jawa Barat', lat: -6.7600, lng: 108.4500, temp: 31, weather: 'Cerah Berawan', uv: 5, condition: 'cerah', tips: 'Gerbang Tol Palimanan. Pastikan e-toll saldo cukup.' },
  { id: 'brebes', name: 'Brebes', type: 'Kabupaten', region: 'Jawa Tengah', lat: -6.8716, lng: 108.9833, temp: 32, weather: 'Cerah', uv: 5, condition: 'cerah', tips: 'Pantura Brebes kering, jalan kondusif.' },
  { id: 'tegal', name: 'Kota Tegal', type: 'Kota', region: 'Jawa Tengah', lat: -6.8694, lng: 109.1402, temp: 32, weather: 'Cerah Berawan', uv: 5, condition: 'cerah', tips: 'Jalan arteri Pantura Tegal kondusif.' },
  { id: 'pemalang', name: 'Pemalang', type: 'Kabupaten', region: 'Jawa Tengah', lat: -6.8922, lng: 109.3760, temp: 31, weather: 'Berawan', uv: 4, condition: 'berawan', tips: 'Mendung tipis, jalanan kering, laju normal.' },
  { id: 'pekalongan', name: 'Kota Pekalongan', type: 'Kota', region: 'Jawa Tengah', lat: -6.8889, lng: 109.6753, temp: 31, weather: 'Cerah Berawan', uv: 5, condition: 'cerah', tips: 'Pantura Pekalongan aman, waspadai rob musim hujan.' },
  { id: 'batang', name: 'Batang', type: 'Kabupaten', region: 'Jawa Tengah', lat: -6.9078, lng: 109.7322, temp: 31, weather: 'Cerah', uv: 5, condition: 'cerah', tips: 'Jalur tol Batang-Semarang lancar.' },
  { id: 'kendal', name: 'Kendal', type: 'Kabupaten', region: 'Jawa Tengah', lat: -6.9272, lng: 110.2015, temp: 31, weather: 'Cerah Berawan', uv: 5, condition: 'cerah', tips: 'Mendekati Semarang, jalan tol kondusif.' },
  { id: 'demak', name: 'Demak', type: 'Kabupaten', region: 'Jawa Tengah', lat: -6.8942, lng: 110.6393, temp: 31, weather: 'Cerah', uv: 5, condition: 'cerah', tips: 'Pantura Demak-Kudus aman dilalui.' },
  { id: 'magelang', name: 'Kota Magelang', type: 'Kota', region: 'Jawa Tengah', lat: -7.4797, lng: 110.2177, temp: 27, weather: 'Berawan', uv: 4, condition: 'berawan', tips: 'Jalur Magelang-Yogya mendung, jalan aman.' },
  { id: 'klaten', name: 'Klaten', type: 'Kabupaten', region: 'Jawa Tengah', lat: -7.7060, lng: 110.6072, temp: 30, weather: 'Cerah Berawan', uv: 5, condition: 'cerah', tips: 'Jalur Solo-Yogya kondusif.' },
  { id: 'salatiga', name: 'Kota Salatiga', type: 'Kota', region: 'Jawa Tengah', lat: -7.3314, lng: 110.5083, temp: 25, weather: 'Berawan', uv: 3, condition: 'berawan', tips: 'Dataran tinggi Salatiga sejuk, aspal kering.' },
  { id: 'argomulyo_solo', name: 'Argomulyo, Cangkringan', type: 'Kecamatan', region: 'Sleman, DIY', lat: -7.6237, lng: 110.4513, temp: 26, weather: 'Berawan', uv: 3, condition: 'berawan', tips: 'Area lereng Merapi, jalan berkelok hati-hati.' },
