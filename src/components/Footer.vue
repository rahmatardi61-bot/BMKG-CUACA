    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
        ...
        <div class="flex flex-wrap items-center justify-center gap-2.5">
          <a href="https://play.google.com/store" target="_blank" class="h-9 px-3.5 rounded-lg border flex items-center gap-2 transition-all hover:scale-105 active:scale-95 bg-slate-900 border-slate-750 text-white dark:bg-brand-navy-900 dark:border-brand-navy-800">
          ...
          <a href="https://www.apple.com/app-store/" target="_blank" class="h-9 px-3.5 rounded-lg border flex items-center gap-2 transition-all hover:scale-105 active:scale-95 bg-slate-900 border-slate-750 text-white dark:bg-brand-navy-900 dark:border-brand-navy-800">
