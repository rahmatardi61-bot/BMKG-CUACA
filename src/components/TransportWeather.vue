  ...
  <div class="space-y-4">
    ...
    <div class="space-y-3">
      <div 
        ...
        :key="item.type"
        class="bg-white/70 dark:bg-brand-navy-900/60 border border-slate-100/50 dark:border-brand-navy-700/20 rounded-2xl p-4 shadow-sm hover:shadow-md transition-all duration-300 flex items-start gap-3 backdrop-blur-md"
      >
