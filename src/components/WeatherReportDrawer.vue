  ...
  <Teleport to="body">
    <div v-if="isOpen" class="fixed inset-0 z-[9999] overflow-hidden flex flex-col justify-end md:flex-row md:justify-end">
      ...
      <Transition name="drawer-slide" appear>
        <div v-if="isOpen"
          class="relative w-full h-[100dvh] md:h-full md:max-w-[480px] bg-white/95 dark:bg-brand-navy-950/95 md:border-l border-none shadow-2xl text-slate-800 dark:text-slate-100 pt-[calc(env(safe-area-inset-top,0px)+16px)] px-5 pb-safe md:pt-6 md:px-6 md:pb-0 flex flex-col overflow-hidden rounded-none"
        >
          <!-- Ambient glow -->
